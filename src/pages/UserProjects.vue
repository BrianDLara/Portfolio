<template>
    <div>
      <h1 class="text-center text-6xl mb-2 py-4">
        Projects 
      </h1>
      <div class="flex flex-col items-center justify-center text-center">
        ...
        <div class="project-container flex justify-evenly items-center flex-col xl:flex-row px-4 py-10 xl:py-4 lg:px-2 xl:px-8 lg:py-16">
          ...
          <div>
            <p class="py-4 px-6 lg:px-2 xl:px-24 self-center">School website where you can see all the courses that the students are taking with their average GPA.</p>
            <div class="flex justify-center my-4">
              <!-- React logo -->
              <img class="devicon-devicon-plain mx-2" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" />
              <!-- css logo -->
        ...
        <div class="project-container flex justify-evenly items-center flex-col xl:flex-row-reverse px-4 py-10 xl:py-4 lg:px-2 xl:px-8 lg:py-16">
          ...
          <div>
            <p class="py-4 px-6 lg:px-2 xl:px-24 self-center">e-commerce website replica. All the styles were done with vanilla CSS.</p>
            <div class="flex justify-center my-4">
              <!-- React logo -->
              <img class="devicon-devicon-plain mx-2" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" />
              <!-- css logo -->
